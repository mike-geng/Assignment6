...
/*!
 * plays round of the game with human moving first
 * @return HUMAN returns who goes next 
 */
 ...
 * @param[out] message the message displayed 
 */
...
/*!
 * gets the input move from the user
 * @return[in] answer returns the move 
 */
 ...
 * @return[in] last_mover() return who went last
 * @return[out] NEAUTRAL determines whos winning 
 */
...
/*!
 * evalautes the move while looking for future moves
 * @param[in] look_ahead evaluates the position of the boad
 * @param[out] beat_this value of other moves 
 * @return[out] evaluate returns evaluation of the move 
 * @return[out] best_value returns best move available
 * @return[out] INT_MIN returns minimum value 
 */
...
/*!
 * makes the AI move and calculates the best move for it
 */
...
/*!
 * allows for the human to move if it is legal
 */
